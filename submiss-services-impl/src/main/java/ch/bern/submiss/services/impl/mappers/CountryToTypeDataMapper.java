...
@Mapper
public abstract class CountryToTypeDataMapper {

  public static final CountryToTypeDataMapper INSTANCE =
      Mappers.getMapper(CountryToTypeDataMapper.class);

  @Mapping(source = "active", target = "isActive")
  @Mapping(source = "countryName", target = "description")
  @Mapping(source = "countryShortName", target = "addedDescription")
  ...
  public abstract List<MasterListTypeDataDTO> toMasterListTypeDataDTOs(
      List<CountryHistoryEntity> countryHistoryEntities);
}
