...
public abstract class OfferDTOMapper {
	...
	private final SubmittentDTOMapper submittentDTOMapper = Mappers.getMapper(SubmittentDTOMapper.class);

	/** The custom submittent mapper. */
	private final CustomSubmittentMapper customSubmittentMapper = Mappers.getMapper(CustomSubmittentMapper.class);
	...
	protected Set<MasterListValueHistoryDTO> masterListValueHistoryEntitySetToMasterListValueHistoryDTOSet(
		...
		for (MasterListValueHistoryEntity masterListValueEntity : set) {
			mset.add(MasterListValueHistoryMapper.INSTANCE.toMasterListValueHistoryDTO(masterListValueEntity));
		}
