...
@Mapper
public abstract class DepartmentToTypeDataMapper {

  public static final DepartmentToTypeDataMapper INSTANCE =
      Mappers.getMapper(DepartmentToTypeDataMapper.class);
  ...
  public abstract MasterListTypeDataDTO toMasterListTypeDataDTO(
      DepartmentHistoryEntity departmentHistoryEntity);
