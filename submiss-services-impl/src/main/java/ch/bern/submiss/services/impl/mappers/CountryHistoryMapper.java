...
public abstract class CountryHistoryMapper {
  ...
  public abstract CountryHistoryEntity toCountryHistory(CountryHistoryDTO dto);

  public abstract List<CountryHistoryEntity> toCountryHistory(List<CountryHistoryDTO> dtoList);

  public abstract CountryHistoryDTO toCountryHistoryDTO(CountryHistoryEntity entity);

  public abstract List<CountryHistoryDTO> toCountryHistoryDTO(
      List<CountryHistoryEntity> countryList);
