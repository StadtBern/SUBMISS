...
public abstract class TenantMapper {
  ...
  public abstract TenantEntity toTenant(TenantDTO dto);

  public abstract List<TenantEntity> toTenant(List<TenantDTO> dtoList);

  public abstract TenantDTO toTenantDTO(TenantEntity entity);

  public abstract List<TenantDTO> toTenantDTO(List<TenantEntity> tenantList);
