...
public interface SDLogibService {
  ...
  LogibHistoryDTO readLogib();

  LogibHistoryDTO readLogibArgib();

  /**
   * Logib history entities to master list type data.
   *
   * @return the type data list
   */
  List<MasterListTypeDataDTO> logibToTypeData();

  /**
   * Gets the logib history entry by id.
   *
   * @param entryId the entry id
   * @return the logib history entry
   */
  LogibHistoryDTO getLogibEntryById(String entryId);
