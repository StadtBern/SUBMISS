...
/**
 * The Class OperationReportDTO.
 */
public class OperationReportDTO extends ReportBaseDTO {
  ...
  /**
   * The publication date direct award from- Publikation Absicht freihändige Vergabe von.
   */
  @JsonView(View.Internal.class)
  private Date publicationDateDirectAwardFrom;

  /**
   * The publication date direct award to - Publikation Absicht freihändige Vergabe bis.
   */
  @JsonView(View.Internal.class)
   ...
   * The intern - Intern/Extern.
   */
  private OperationReportResultsDTO operationReportResults;
   ...
   *
   * @param publicationDateAwardFrom the new publication date award from
   */
   ...
   *
   * @param publicationDateAwardTo the new publication date award to
   */
   ...
   *
   * @param publicationDateFrom the new publication date from
   */
   ...
   *
   * @param publicationDateTo the new publication date to
   */
   ...
   *
   * @param applicationOpeningDateFrom the new application opening date from
   */
   ...
   *
   * @param applicationOpeningDateTo the new application opening date to
   */
   ...
   *
   * @param offerOpeningDateFrom the new offer opening date from
   */
   ...
   *
   * @param offerOpeningDateTo the new offer opening date to
   */
   ...
   *
   * @param commissionProcurementProposalDateFrom the new commission procurement proposal date from
   */
   ...
   *
   * @param commissionProcurementProposalDateTo the new commission procurement proposal date to
   */
   ...
   *
   * @param firstDeadlineFrom the new first deadline from
   */
   ...
   *
   * @param firstDeadlineTo the new first deadline to
   */
   ...
   *
   * @param secondDeadlineFrom the new second deadline from
   */
   ...
   *
   * @param secondDeadlineTo the new second deadline to
   */
   ...
   *
   * @param firstLevelavailableDateFrom the new first levelavailable date from
   */
   ...
   *
   * @param firstLevelavailableDateTo the new first levelavailable date to
   */
   ...
   *
   * @param levelavailableDateFrom the new levelavailable date from
   */
   ...
   *
   * @param levelavailableDateTo the new levelavailable date to
   */
   ...
   *
   * @param cancelationreasons the new cancelationreasons
   */
   ...
   *
   * @param reasonFreeAwards the new reason free awards
   */
  ...
  /**
   * Gets the operation report results.
   *
   * @return the operation report results
   */
  public OperationReportResultsDTO getOperationReportResults() {
    return operationReportResults;
  }

  /**
   * Sets the operation report results.
   *
   * @param operationReportResults the new operation report results
   */
  public void setOperationReportResults(OperationReportResultsDTO operationReportResults) {
    this.operationReportResults = operationReportResults;
  }
   ...
   *
   * @param publicationDateDirectAwardFrom the new publication date direct award from
   */
   ...
   *
   * @param publicationDateDirectAwardTo the new publication date direct award to
   */
   ...
   * (non-Javadoc)
   *
   * @see ch.bern.submiss.services.api.dto.ReportBaseDTO#toString()
   */
  @Override
  public String toString() {
    return "OperationReportDTO [description=" + description + ", publicationDateAwardFrom="
      + publicationDateAwardFrom + ", publicationDateAwardTo=" + publicationDateAwardTo
      + ", publicationDateFrom=" + publicationDateFrom + ", publicationDateTo="
      + publicationDateTo + ", applicationOpeningDateFrom=" + applicationOpeningDateFrom
      + ", applicationOpeningDateTo=" + applicationOpeningDateTo + ", offerOpeningDateFrom="
      + offerOpeningDateFrom + ", offerOpeningDateTo=" + offerOpeningDateTo
      + ", commissionProcurementProposalDateFrom=" + commissionProcurementProposalDateFrom
      + ", commissionProcurementProposalDateTo=" + commissionProcurementProposalDateTo
      + ", awardCompany=" + awardCompany + ", notes=" + notes + ", gattWto=" + gattWto
      + ", publicationDateDirectAwardFrom=" + publicationDateDirectAwardFrom
      + ", publicationDateDirectAwardTo=" + publicationDateDirectAwardTo + ", firstDeadlineFrom="
      + firstDeadlineFrom + ", firstDeadlineTo=" + firstDeadlineTo + ", secondDeadlineFrom="
      + secondDeadlineFrom + ", secondDeadlineTo=" + secondDeadlineTo
      + ", firstLevelavailableDateFrom=" + firstLevelavailableDateFrom
      + ", firstLevelavailableDateTo=" + firstLevelavailableDateTo + ", levelavailableDateFrom="
      + levelavailableDateFrom + ", levelavailableDateTo=" + levelavailableDateTo
      + ", cancelationreasons=" + cancelationreasons + ", reasonFreeAwards=" + reasonFreeAwards
      + ", intern=" + intern + ", operationReportResults=" + operationReportResults + "]";
  }
