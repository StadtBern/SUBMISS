...
/**
 * The Class AwardInfoOfferFirstLevelDTO.
 */
public class AwardInfoOfferFirstLevelDTO {
  ...
  private Set<MasterListValueDTO> exclusionReasonsFirstLevel;
   ...
   */
  public Set<MasterListValueDTO> getExclusionReasonsFirstLevel() {
   ...
   */
  public void setExclusionReasonsFirstLevel(Set<MasterListValueDTO> exclusionReasonsFirstLevel) {
