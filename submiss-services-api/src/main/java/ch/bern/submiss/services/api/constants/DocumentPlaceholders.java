...
public enum DocumentPlaceholders {
  ...
  BA_AWARD_AMOUNT("ba_award_amount"),
  BA_AWARD_TEXT("ba_award_text"),
  BA_AWARD_OPER("ba_award_oper"),
  ...
  FIRST_LEVEL_EXCLUSION_REASON("first_level_exclusion_reason"),
  FIRST_LEVEL_AWARD_REASON("first_level_award_reason"),
