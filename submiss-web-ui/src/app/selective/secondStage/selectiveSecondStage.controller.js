...
/**
 * @ngdoc controller
 * @name selectiveSecondStage.controller.js
 * @description SelectiveSecondStageController controller
 */
(function () {
  "use strict";

  angular // eslint-disable-line no-undef
    .module("submiss").controller("SelectiveSecondStageController",
      SelectiveSecondStageController);

  /** @ngInject */
  function SelectiveSecondStageController($rootScope, $scope, $stateParams, SubmissionService, $state) {
    const vm = this;
    /***********************************************************************
     * Local variables.
     **********************************************************************/
    ...
    function navigateToDefaultState() {
      if ($state.current.name === "selectiveSecondStage" ||
        $state.current.name === "offerListView") {
