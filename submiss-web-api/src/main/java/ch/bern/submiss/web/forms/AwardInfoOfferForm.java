...
public class AwardInfoOfferForm {
  ...
  private Set<MasterListValueForm> exclusionReasons;
   ...
   */
  public Set<MasterListValueForm> getExclusionReasons() {
   ...
   */
  public void setExclusionReasons(Set<MasterListValueForm> exclusionReasons) {
  ...
  public String toString() {
    return "AwardInfoOfferForm [id=" + id + ", submittentName=" + submittentName
        + ", existsExclusionReasons=" + existsExclusionReasons + ", formalExaminationFulfilled="
        + formalExaminationFulfilled + ", mustCriteriaFulfilled=" + mustCriteriaFulfilled
        + ", qExExaminationIsFulfilled=" + qExExaminationIsFulfilled + ", isAwarded=" + isAwarded
        + ", amount=" + amount + ", manualAmount=" + manualAmount + ", exclusionReason="
        + exclusionReason + ", exclusionReasons=" + exclusionReasons + "]";
  }
}
