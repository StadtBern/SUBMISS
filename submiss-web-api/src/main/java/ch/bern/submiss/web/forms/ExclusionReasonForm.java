...
/**
 * The Class ExclusionReasonForm.
 */
public class ExclusionReasonForm {

  /** The exclusion reason. */
  private MasterListValueHistoryForm exclusionReason;
   ...
   */
  public MasterListValueHistoryForm getExclusionReason() {
   ...
   */
  public void setExclusionReason(MasterListValueHistoryForm exclusionReason) {
